...
public class EntityUtil {
    ...
    private final String moduleName = "db0"; // 数据库名称

    private final String localpath = "/Users/admin/Desktop/";

    private final String bean_path = localpath + "spring-boot-example-all/spring-boot-sharding/src/main/java";

    private final String mapper_path = localpath + "spring-boot-example-all/spring-boot-sharding/src/main/java";

    private final String xml_path = localpath
            + "spring-boot-example-all/spring-boot-sharding/src/main/resources/mappers";// xml路径

    private final String model_package = "com.example.domain";// model的包所在

    private final String dao_package = "com.example.dao";// dao的包所在
    ...
    private final String url = "jdbc:mysql://rm-bp10zmrn4k515v071o.mysql.rds.aliyuncs.com:3306/" + moduleName + "?characterEncoding=utf8";
    ...
    private List<String> getTables() throws SQLException {
        ...
        while (results.next()) {
            ...
            if (tableName.toLowerCase().contains("t_user")) {
    ...
    private boolean processTypeIfCase(String type) {
        if (type.indexOf(type_char) > -1) {
            ...
            return type.indexOf(type_text) > -1;
    }
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(
                new OutputStreamWriter(new FileOutputStream(mapperFile), StandardCharsets.UTF_8));
        ...
        bw.newLine();
        bw.write("import com.puhui.utils.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
    ...
    public static HttpEntity getHttpEntity(Map<String, Object> requestBody) {
        return getHttpEntity(requestBody, MediaType.APPLICATION_FORM_URLENCODED);
    }

    public static HttpEntity getHttpEntity(Map<String, Object> requestBody, MediaType mediaType) {
    ...
    public static HttpEntity getHttpEntity(String requestBody, MediaType mediaType) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.setContentType(mediaType);
        return new HttpEntity<String>(requestBody, httpHeaders);
    }
}